...
<AccordionGroup>
  ...
  <Accordion title="Alternative C: Intelligent-Tiering (S3 Intelligent-Tiering class)">
    ...
    **Why partially adopted but not primary:** S3 Intelligent-Tiering has per-object monitoring charges. At 8 PB with millions of small-to-medium files, monitoring costs exceed the saving for small objects (<128 KB). Applied selectively to thumbnail and small metadata files. Not used for video/audio segments where the custom engine is more cost-effective.
  </Accordion>
</AccordionGroup>
